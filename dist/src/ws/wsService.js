...
var WSService = /** @class */ (function () {
    ...
    WSService.prototype.connect = function () {
        ...
        this.socket = new ws_1.default(process.env.CHATSERVER_URL);
    ...
    WSService.prototype.sendMessage = function (rawMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        var message = JSON.stringify(rawMessage);
                        if (_this.socket && _this.socket.readyState === ws_1.default.OPEN) {
